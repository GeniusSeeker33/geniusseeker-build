// 32-question upgraded STEAM assessment
// Changes from v1:
//   - 5 new questions: comp structure, wage range, work location, work style, interdisciplinary signal
//   - Level questions distributed throughout (not stacked at end)
//   - New categories: CompStructure, WageRange, WorkLocation, WorkStyle (stored in answers, used in profile)

const questions = [
  // ── STEAM QUESTIONS (1–12) ──────────────────────────────────────────
  ...
  // ── LEVEL SIGNAL #1 (distributed) ──────────────────────────────────
  // 6. Complexity comfort
  {
  ...
  // ── NEW: WORK STYLE ────────────────────────────────────────────────
  // 9. Solo vs collaborative
  {
    question: "When you do your best work, you're usually:",
    options: [
      { label: "Working independently with deep focus and minimal interruption", category: "WorkStyle", weight: 1.0, value: "independent" },
      { label: "Collaborating closely — energy from the team fuels my output", category: "WorkStyle", weight: 1.0, value: "collaborative" },
      { label: "A mix — I need both solo deep work and regular team touchpoints", category: "WorkStyle", weight: 1.0, value: "hybrid_style" },
      { label: "Leading and coordinating — I do my best when I'm guiding others", category: "WorkStyle", weight: 1.0, value: "leading" },
      { label: "It depends entirely on the project and who I'm working with", category: "WorkStyle", weight: 1.0, value: "flexible" },
    ],
  },
  ...
  // ── LEVEL SIGNAL #2 (distributed) ──────────────────────────────────
  // 13. Field relationship
  {
    ...
    options: [
      ...
      { label: "I'm recognized as an expert and mentor who shapes direction in my field", category: "Level5", weight: 1.0 },
    ],
  },

  // ── STEAM QUESTIONS (14–22) ─────────────────────────────────────────
  ...
  // ── NEW: WORK LOCATION ─────────────────────────────────────────────
  // 16. Remote vs in-person
  {
    question: "Where do you do your best, most fulfilling work?",
    options: [
      { label: "Fully remote — I thrive with autonomy and no commute", category: "WorkLocation", weight: 1.0, value: "remote" },
      { label: "In-office — I need the energy, structure, and face time", category: "WorkLocation", weight: 1.0, value: "onsite" },
      { label: "Hybrid — a few days remote, a few days in the office", category: "WorkLocation", weight: 1.0, value: "hybrid" },
      { label: "Flexible — as long as the work gets done, location doesn't matter", category: "WorkLocation", weight: 1.0, value: "flexible" },
      { label: "I travel for work or work across multiple locations regularly", category: "WorkLocation", weight: 1.0, value: "traveling" },
    ],
  },

  // 17. Detail vs big picture
  {
  ...
  // 19. Base vs commission
  {
    question: "When it comes to how you're paid, which structure feels most aligned with how you work?",
    options: [
      { label: "I prefer a predictable base salary — I want to know exactly what I'll earn", category: "CompStructure", weight: 1.0, value: "base_only" },
      { label: "I'm excited by base + commission — I want to be rewarded for results", category: "CompStructure", weight: 1.0, value: "base_plus_commission" },
      { label: "I prefer performance bonuses on top of a fair base — tied to outcomes", category: "CompStructure", weight: 1.0, value: "base_plus_bonus" },
      { label: "I'm open to higher commission/equity if the upside potential is real", category: "CompStructure", weight: 1.0, value: "commission_heavy" },
      { label: "I want project-based or contract pay — I like being paid per deliverable", category: "CompStructure", weight: 1.0, value: "project_based" },
    ],
  },

  // 20. Innovation pattern
  {
  ...
  // ── NEW: WAGE RANGE ────────────────────────────────────────────────
  // 24. Ideal compensation
  {
    question: "What is your ideal total annual compensation for the right role?",
    options: [
      { label: "Under $50,000 — I'm early in my career and focused on growth", category: "WageRange", weight: 1.0, value: "under_50k" },
      { label: "$50,000–$80,000 — building my career and earning steadily", category: "WageRange", weight: 1.0, value: "50k_80k" },
      { label: "$80,000–$120,000 — established professional, mid-level range", category: "WageRange", weight: 1.0, value: "80k_120k" },
      { label: "$120,000–$180,000 — senior contributor or specialist", category: "WageRange", weight: 1.0, value: "120k_180k" },
      { label: "$180,000+ — executive, principal, or top-of-field professional", category: "WageRange", weight: 1.0, value: "180k_plus" },
    ],
  },
  ...
  // ── NEW: INTERDISCIPLINARY SIGNAL ─────────────────────────────────
  // 27. Where STEAM categories intersect for this person
  {
    question: "If you had to pick your two strongest modes, which combination feels most like you?",
    options: [
      { label: "Analytical + Technical — I dig deep into problems using data and tools", category: "Technology", weight: 0.8, secondary: "Science" },
      { label: "Creative + Strategic — I bring vision and back it with sharp thinking", category: "Arts", weight: 0.8, secondary: "Math" },
      { label: "Structural + Analytical — I build solid systems grounded in evidence", category: "Engineering", weight: 0.8, secondary: "Science" },
      { label: "Creative + Technical — I design beautiful things powered by technology", category: "Arts", weight: 0.8, secondary: "Technology" },
      { label: "Strategic + Structural — I turn big ideas into operational reality", category: "Math", weight: 0.8, secondary: "Engineering" },
    ],
  },
  ...
  // ── LEVEL SIGNAL #4 (final) ─────────────────────────────────────────
  // 31. Growth investment
  {
  ...
  // 32. Preferred collaboration partner
  {
